...
<tr height="500" align="center">
		<td align="center" width="1000"><jsp:include page="../Header.jsp" /></td>
		</tr>
		<style>
		#boa{
		margin-top:200px;
...
<table width="700" border="1" bordercolor="skyblue">
	<tr height="40" align="right">
		...
		<form action="" name="search" method="get"></tr>
		...
		<input type="button" value="검색" onclick="check()">
			...
			<button onclick="location.href='Board/BoardWriteForm.jsp'">글쓰기</button>
	</td>
	<tr height="40">
...
<!-- 페이지 카운터링 소스를 작성 -->
	<c:if test="${count>0 }">
		...
		<c:set var="startPage" value="${1 }" />
			<c:if test="${currentPage%10!=0 }"></c:if>
					<!-- 결과를 정수형으로 리턴받아야하기에 fmt태그를 써서 -->
